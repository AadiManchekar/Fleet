...
public class FeatureFlag {
    ...
    public FeatureFlag(VaultTemplate vaultTemplate) {
    ...
    private void writeSecretsToVault() {
        ...
        secrets.put("differentiateVehicleType", "false");
        secrets.put("enableAutoIncrementSearchRadius", "false");

        Map<String, Object> data = new HashMap<>();
        data.put("data", secrets);

        vaultTemplate.write("secret/data/internal/feature_flag", data);
        log.info("Feature Flags have been written to Vault");
    }
}
